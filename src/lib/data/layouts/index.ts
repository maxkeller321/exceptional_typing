...
export const qwertyEs: KeyboardLayout = {
  id: 'qwerty-es',
  name: 'QWERTY (Spanish)',
  locale: 'es-ES',
  rows: [
    [
      { key: 'º', shift: 'ª', finger: 1 },
      { key: '1', shift: '!', finger: 1 },
      { key: '2', shift: '"', finger: 2 },
      { key: '3', shift: '·', finger: 3 },
      { key: '4', shift: '$', finger: 4 },
    ...
    [
      ...
      { key: 'k', shift: 'K', finger: 8, home: true },
      { key: 'l', shift: 'L', finger: 9, home: true },
      { key: 'ñ', shift: 'Ñ', finger: 10, home: true },
      { key: '´', shift: '¨', finger: 10 },
      { key: 'ç', shift: 'Ç', finger: 10 },
    ],
    [
      { key: '<', shift: '>', finger: 1 },
      { key: 'z', shift: 'Z', finger: 1 },
...
export const qwertyIt: KeyboardLayout = {
  id: 'qwerty-it',
  name: 'QWERTY (Italian)',
  locale: 'it-IT',
  rows: [
    ...
    [
      ...
      { key: 'k', shift: 'K', finger: 8, home: true },
      { key: 'l', shift: 'L', finger: 9, home: true },
      { key: 'ò', shift: 'ç', finger: 10, home: true },
      { key: 'à', shift: '°', finger: 10 },
      { key: 'ù', shift: '§', finger: 10 },
    ],
    [
      { key: '<', shift: '>', finger: 1 },
...
// QWERTY Portuguese Layout
export const qwertyPt: KeyboardLayout = {
  id: 'qwerty-pt',
  ...
  rows: [
    ...
    [
      ...
      { key: 'k', shift: 'K', finger: 8, home: true },
      { key: 'l', shift: 'L', finger: 9, home: true },
      { key: 'ç', shift: 'Ç', finger: 10, home: true },
      { key: 'º', shift: 'ª', finger: 10 },
      { key: '~', shift: '^', finger: 10 },
    ],
    [
      { key: '<', shift: '>', finger: 1 },
...
export const qwertySe: KeyboardLayout = {
  id: 'qwerty-se',
  name: 'QWERTY (Swedish)',
  locale: 'sv-SE',
  rows: [
...
// QWERTY Norwegian Layout
export const qwertyNo: KeyboardLayout = {
  id: 'qwerty-no',
  ...
  rows: [
    ...
    [
      ...
      { key: 'k', shift: 'K', finger: 8, home: true },
      { key: 'l', shift: 'L', finger: 9, home: true },
      { key: 'ø', shift: 'Ø', finger: 10, home: true },
      { key: 'æ', shift: 'Æ', finger: 10 },
      { key: "'", shift: '*', finger: 10 },
    ],
    [
      { key: '<', shift: '>', finger: 1 },
...
// QWERTY Danish Layout
export const qwertyDk: KeyboardLayout = {
  id: 'qwerty-dk',
  name: 'QWERTY (Danish)',
  locale: 'da-DK',
  rows: [
    ...
    [
      ...
      { key: 'k', shift: 'K', finger: 8, home: true },
      { key: 'l', shift: 'L', finger: 9, home: true },
      { key: 'æ', shift: 'Æ', finger: 10, home: true },
      { key: 'ø', shift: 'Ø', finger: 10 },
      { key: "'", shift: '*', finger: 10 },
    ],
    [
      { key: '<', shift: '>', finger: 1 },
...
// QWERTY Swiss French Layout
export const qwertyChFr: KeyboardLayout = {
  id: 'qwerty-ch-fr',
  name: 'QWERTZ (Swiss French)',
  locale: 'fr-CH',
  rows: [
    [
      { key: '§', shift: '°', finger: 1 },
    ...
    [
      ...
      { key: 'k', shift: 'K', finger: 8, home: true },
      { key: 'l', shift: 'L', finger: 9, home: true },
      { key: 'é', shift: 'ö', finger: 10, home: true },
      { key: 'à', shift: 'ä', finger: 10 },
      { key: '$', shift: '£', finger: 10 },
    ],
    [
      { key: '<', shift: '>', finger: 1 },
...
// QWERTY Turkish Layout (Turkish-Q)
export const qwertyTr: KeyboardLayout = {
  id: 'qwerty-tr',
  name: 'QWERTY (Turkish)',
  locale: 'tr-TR',
  rows: [
    [
      { key: '"', shift: 'é', finger: 1 },
      { key: '1', shift: '!', finger: 1 },
      { key: '2', shift: "'", finger: 2 },
      { key: '3', shift: '^', finger: 3 },
      { key: '4', shift: '+', finger: 4 },
    ...
    [
      ...
      { key: 'y', shift: 'Y', finger: 7 },
      { key: 'u', shift: 'U', finger: 7 },
      { key: 'ı', shift: 'I', finger: 8 },
      { key: 'o', shift: 'O', finger: 9 },
      { key: 'p', shift: 'P', finger: 10 },
      { key: 'ğ', shift: 'Ğ', finger: 10 },
      { key: 'ü', shift: 'Ü', finger: 10 },
    ],
    [
      { key: 'a', shift: 'A', finger: 1, home: true },
      ...
      { key: 'k', shift: 'K', finger: 8, home: true },
      { key: 'l', shift: 'L', finger: 9, home: true },
      { key: 'ş', shift: 'Ş', finger: 10, home: true },
      { key: 'i', shift: 'İ', finger: 10 },
      { key: ',', shift: ';', finger: 10 },
    ],
    [
      { key: '<', shift: '>', finger: 1 },
      ...
      { key: 'n', shift: 'N', finger: 7 },
      { key: 'm', shift: 'M', finger: 7 },
      { key: 'ö', shift: 'Ö', finger: 8 },
      { key: 'ç', shift: 'Ç', finger: 9 },
      { key: '.', shift: ':', finger: 10 },
    ],
    [
      { key: ' ', label: 'Space', width: 6, finger: 5 },
...
export const azertyBe: KeyboardLayout = {
  id: 'azerty-be',
  name: 'AZERTY (Belgian)',
  locale: 'fr-BE',
  rows: [
